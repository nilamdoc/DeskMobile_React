...
function DeskMobileLink(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `dm-wrapper ${className || ""}`, children: [
    /* @__PURE__ */ jsx("style", { children: deskMobileDefaultStyles }),
    /* @__PURE__ */ jsxs("div", { className: "dm-card", children: [
      /* @__PURE__ */ jsx("div", { className: "dm-logo", children: logoText }),
      /* @__PURE__ */ jsx("h1", { className: "dm-title", children: title }),
      /* @__PURE__ */ jsx("p", { className: "dm-subtitle", children: subtitle }),
      /* @__PURE__ */ jsx("div", { className: "dm-qr-box", children: qrPayload ? /* @__PURE__ */ jsx(QRCodeCanvas, { value: qrPayload, size }) : /* @__PURE__ */ jsx("div", { className: "dm-placeholder", children: status === "creating" ? "Creating QR..." : "No QR available" }) }),
      /* @__PURE__ */ jsx("div", { className: statusClass, children: error || message }),
      /* @__PURE__ */ jsxs("div", { className: "dm-actions", children: [
        /* @__PURE__ */ jsx("button", { type: "button", className: "dm-btn", onClick: createLink, children: "Generate New QR" }),
        status === "pending" && /* @__PURE__ */ jsx("button", { type: "button", className: "dm-btn dm-btn-light", onClick: cancelLink, children: "Cancel" })
      ] }),
      showPayload && qrPayload && /* @__PURE__ */ jsxs("div", { className: "dm-payload", children: [
        /* @__PURE__ */ jsx("strong", { children: "QR Payload:" }),
        /* @__PURE__ */ jsx("br", {}),
        qrPayload
      ] })
    ] })
